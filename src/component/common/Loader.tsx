export function Loader() {
  return (
    <div className="flex flex-col items-center justify-center text-white">
      <div className="relative w-32 h-32 rounded-full border-[3px] border-white overflow-hidden bg-[#3344c1] shadow-inner animate-[startround_1s_1]">
        <svg xmlns="http://www.w3.org/2000/svg" viewBox="0 0 200 200" className="absolute bottom-[-2em] w-28 h-auto animate-[round1_5s_linear_infinite_0.75s]">
        ...
        <svg xmlns="http://www.w3.org/2000/svg" viewBox="0 0 200 200" className="absolute top-[-3em] w-28 h-auto animate-[round1_5s_linear_infinite]">
        ...
        <svg xmlns="http://www.w3.org/2000/svg" viewBox="0 0 200 200" className="absolute top-[-2.5em] w-28 h-auto animate-[round2_5s_linear_infinite]">
        ...
        <svg xmlns="http://www.w3.org/2000/svg" viewBox="0 0 200 200" className="absolute bottom-[-2.2em] w-28 h-auto animate-[round2_5s_linear_infinite_0.75s]">
      ...
      <p className="pt-1 text-lg font-sans">Please wait...</p>
    </div>
  );
}
